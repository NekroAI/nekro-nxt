...
- `web`：NekroNXT Shell、Host UI 页面 Runtime、DSH Settings 与 Cordis Config 通用 Schema 表单、动态创造 Client Runtime，以及智能体/Adapter 产品 Slot。DSH 原生 WebUI、侧栏、Composer 和页面 Slot 不加载；DSH 包只有显式 `nekroNxt.hostUi` 才能贡献 NXT 页面。
