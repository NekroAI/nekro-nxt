...
> 归档日期：2026-08-19。设计长文，已冻结，不是现行规范。现行契约见 `docs/decisions/accepted/2026-08-15-首个QQ-OpenClaw-Adapter.md`。

状态：accepted

离线协议、凭据宿主与生产连接装配已经落地。现行缺口是真实账号环境验收，见 `04-一期开发计划与决策清单.md`。
