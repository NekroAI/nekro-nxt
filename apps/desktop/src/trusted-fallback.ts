...
export const FALLBACK_MIN_VISIBLE_MS = 2_000
export const FALLBACK_TRANSITION_MS = 240
...
export interface TrustedFallbackRenderInput {
  ...
  readonly initialVisibility?: 'entering' | 'open'
  readonly instance: {
